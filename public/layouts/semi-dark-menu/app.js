                ...
                document.querySelector('.sidebar-wrapper').addEventListener(e, function() {
                    if (document.querySelector('body').classList.contains('alt-menu')) {
                        if (document.querySelector('.main-container').classList.contains('sidebar-closed')) {
                            if (e === 'mouseenter') {
                                var menuSubmenu = document.querySelector('li.menu .submenu');
                                if (menuSubmenu) {
                                    menuSubmenu.classList.remove('show');
                                }
                                
                                var activeMenuSubmenu = document.querySelector('li.menu.active .submenu');
                                if (activeMenuSubmenu) {
                                    activeMenuSubmenu.classList.add('recent-submenu');
                                    
                                    var activeMenu = document.querySelector('li.menu.active');
                                    if (activeMenu) {
                                        var submenuRecent = activeMenu.querySelector('.collapse.submenu.recent-submenu');
                                        if (submenuRecent) {
                                            submenuRecent.classList.add('show');
                                            
                                            var recentSubmenu = document.querySelector('.collapse.submenu.recent-submenu');
                                            if (recentSubmenu && recentSubmenu.parentNode) {
                                                var dropdownToggle = recentSubmenu.parentNode.querySelector('.dropdown-toggle');
                                                if (dropdownToggle) {
    ...
    var inBuiltfunctionality = {
        ...
        onCheckandChangeSidebarActiveClass: function() {
            if (document.body.classList.contains('alt-menu')) {
                var expandedElement = document.querySelector('.sidebar-wrapper li.menu.active [aria-expanded="true"]');
                if (expandedElement) {
